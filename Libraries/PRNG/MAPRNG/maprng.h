...
// ===============================================================================
//
// Ѕиблиотека генератора псевдослучайных чисел на основе измен€емого массива
...
// 8, 16 и 32 бита (а также числа в установленном диапазоне), использу€
// измен€емый массив с адресами от 0x00 до max_eeprom_addr,
// который задаЄтс€ в параметрах функции. ќсновна€ €чейка пам€ти также
// задаЄтс€ в параметрах функции.
// ¬ качестве измен€емого массива можно использовать участок любого типа пам€ти
// (внутренн€€ или внешн€€ RAM, EEPROM и т.д.). –абота с пам€тью описываетс€
