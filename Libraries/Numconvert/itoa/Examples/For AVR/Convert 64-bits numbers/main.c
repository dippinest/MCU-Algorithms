...
int main(void)
{
	...
	UART_String_Transmit("Macro \"MIN_I64_VAL\"       = "); UART_StringLn_Transmit(ITOA_Int64_To_String(MIN_I64_VAL,        21));
	UART_String_Transmit("Macro \"MAX_I64_VAL\"       = "); UART_StringLn_Transmit(ITOA_Int64_To_String(MAX_I64_VAL,        21));
