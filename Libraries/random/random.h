...
// ===============================================================================
//
// Ѕиблиотека, облегчающа€ работу со стандартной функцией √ѕ—„ rand().
//
// ‘ункции позвол€ют удобно получать псевдослучайные числа в диапазоне,
// указываемом в параметрах.
//
// ƒоступны следующие функции:
//
// 1. void Random_LCG_Set_Seed(uint16_t seed) - установка начального значени€
//         rand(). явл€етс€ полным аналогом функции srand(uint16_t seed)
//
