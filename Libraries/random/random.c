...
{
	uint16_t r = Random_LCG_Get_UInt16_Value((uint16_t)min, (uint16_t)max);
...
{
	uint32_t r = (uint32_t)Random_LCG_Get_UInt16_Value(0, 65535);

	r <<= 16;
	
	r |= Random_LCG_Get_UInt16_Value(0, 65535);
...
{
	uint32_t r = Random_LCG_Get_UInt32_Value((uint32_t)min, (uint32_t)max);
