...
// ===============================================================================
//
// Библиотека с реализацией простейших цифровых фильтров
//
// -------------------------------------------------------------------------------
//
// Library with implementation of the simplest digital filters
//
// ===============================================================================
...
// adaptive exponentially weighted moving average (IIR filter) - here the
// coefficient adapts to the difference between the current and the previous value
